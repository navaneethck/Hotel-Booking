  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
      ...
      <div className="mb-4">
        ...
        <div className="flex">
          <select className="p-2.5 sm:p-3 border rounded-l-md bg-gray-50 text-sm sm:text-base">
            <option>+91</option>
          </select>
          <input
            type="tel"
            placeholder="Enter phone number"
            className="flex-1 p-2.5 sm:p-3 border-t border-r border-b rounded-r-md text-sm sm:text-base"
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          className="w-full p-2.5 sm:p-3 border rounded-md resize-none text-sm sm:text-base"
