  ...
  <section className="bg-purple-500 py-10 fixed top-16 left-0 w-full h-20">
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row gap-4 bg-white p-4 rounded-lg shadow-lg">
        <input type="text" placeholder="Search destination" className="flex-1 p-3 rounded-md border" value={destination}/>
        <input type="date" className="p-3 rounded-md border" value={checkIn}/>
        <input type="date" className="p-3 rounded-md border" value={checkOut} />
        <input type="number" min="1" placeholder="Guests" className="p-3 rounded-md border w-28" value={guest} />
